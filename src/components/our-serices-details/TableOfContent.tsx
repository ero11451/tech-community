              ...
              return (
                <li key={item.id}>
                  <Link
                    ...
                    className={`group py-4 flex items-center justify-between transition-all duration-300 ease-out hover:bg-gray-50/50 dark:hover:bg-gray-800/30 rounded-lg px-2 -mx-2 ${!isLastItem ? 'border-b border-b-stroke-4 dark:border-b-stroke-7' : ''
                      }`}>
                    <span
                      className={`text-lg leading-[27px] transition-all duration-300 ease-out ${isActive
                    ...
                    <span
                      className={`transition-all duration-300 ease-out transform ${isActive
